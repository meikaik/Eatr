...
- (void)viewDidLoad {
    ...
    arrayImages = [[NSArray alloc]initWithObjects:@"OrangeJuice.png", @"Milk.png", @"Banana.png", @"Bacon.png", @"Pizza-Slice.png", @"BeefSteakTomato.png", @"BreakfastSausage.png", @"Broccoli.png", @"Carrots.png", @"Cereal.png", @"CheddarCheese.png", @"Chicken.png", @"ChickenNoodleSoup.png", @"Chickpeas.png", @"Egg.png", @"Gourmet-Burger.png", @"GreenPepper.png", @"Hummus.png", @"ItalianBread.png", @"Muffin.png", @"Oatmeal.png", @"Pancake.png", @"PlainBagel.png", @"RedPepper.png", @"Rice.png", @"Salmon.png", @"Spinach.png", @"Tofu.png", nil];
}
